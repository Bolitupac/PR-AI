...
<head>
    ...
    <title>503 – Under maintenance | PR ai</title>
...
<body>
    <div class="error-card">
        ...
        <span class="error-tag">503</span>
        <h1 class="error-title">Be right back</h1>
        <p class="error-desc">
            PR ai is temporarily down for maintenance. We should be back shortly.
